...
onEachFeature: function (feature, layer) {
    if (feature.properties) {
      var content = "<table class='table table-striped table-bordered table-condensed'>" + "<tr><th>Te Urewera current hunting availability</th><td>" + feature.properties.block + "</td></tr>" + "<table>";
      layer.on({
        click: function (e) {
...
$.getJSON("data/hunting.geojson", function (data) {
...
var campsites = L.geoJson(null, {
  ...
  onEachFeature: function (feature, layer) {
    if (feature.properties) {
      var content = "<table class='table table-striped table-bordered table-condensed'>" + "<tr><th>Name</th><td>" + feature.properties.NAME + "</td></tr>" + "<tr><th>Booking</th><td>" + feature.properties.booking + "</td></tr>" + "<table>";
      layer.on({
        click: function (e) {
...
var huts = L.geoJson(null, {
  ...
  onEachFeature: function (feature, layer) {
    if (feature.properties) {
      var content = "<table class='table table-striped table-bordered table-condensed'>" + "<tr><th>Name</th><td>" + feature.properties.NAME + "</td></tr>" + "<tr><th>Capacity</th><td>" + feature.properties.sleep + "</td></tr>" + "<tr><th>Heating</th><td>" + feature.properties.heat + "</td></tr>" + "<tr><th>Booking</th><td>" + feature.properties.booking + "</td></tr>" + "<table>";
      layer.on({
        click: function (e) {
          $("#feature-title").html(feature.properties.category);
          $("#feature-info").html(content);
          $("#featureModal").modal("show");
          highlight.clearLayers().addLayer(L.circleMarker([feature.geometry.coordinates[1], feature.geometry.coordinates[0]], highlightStyle));
        }
...
var groupedOverlays = {
  "Points of Interest": {
    "<img src='assets/img/marae16.png' width='16' height='18'>&nbsp;Marae": maraeLayer,
